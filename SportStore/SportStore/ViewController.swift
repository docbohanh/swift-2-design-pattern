...
class ProductTableCell: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(handleStockLevelUpdate(_:)), name: "stockUpdate", object: nil)
    }
...
//                        undoManager?.registerUndoWithTarget(self, selector: #selector(undoStockLevel(_:)), object: dict)
                        undoManager?.registerUndoWithTarget(self, selector: #selector(resetState), object: dict)
