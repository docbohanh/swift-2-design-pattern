...
final class ProductDataStore {
    ...
    private func loadData() -> [Product] {
        ...
        for product in productData {
            ...
            dispatch_async(self.networkQ) {
                StockServerFactory.getStockServer().getStockLevel(p.name) { (name, stockLevel) in
    ...
    private var productData: [Product] = [
        ...
        Product.createProduct("Stadium", description: "Flat-packed 35,0000-seat stadium", category: "Soccer", price: 79500.0, stockLevel: 0),
        Product.createProduct("Thinking Cap", description: "Improve your brain efficiency by 75%", category: "Chess", price: 16.0, stockLevel: 0),
        Product.createProduct("Unsteady Chair", description: "Secretly give you opponent a disadvantage", category: "Chess", price: 29.95, stockLevel: 0),
